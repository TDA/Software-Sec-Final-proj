...
var VirtualKeyboard = new function() {
	var I = this;
	I.$VERSION$ = "Software Security Group 4";
	...
	(function() {
		...
		U.keyboard.innerHTML = ("<div id=\"kbDesk\"><!-- --></div>"
				...
				+ "<select id=\"kb_mappingselecto\"></select>"
				+ '<div id="copyrights" nofocus="true"><a href="http://asu.edu" target="_blank" title="&copy;2006-2009 Debugger.ru">Security VirtualKeyboard: '
...
VirtualKeyboard.IME = new function() {
	var i = this;
	var I = "<div id=\"VirtualKeyboardIME\"><table><tr><td class=\"IMEControl\"><div class=\"left\"><!-- --></div></td>"
