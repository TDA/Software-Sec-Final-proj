...
<title>Administrator Portfolio - Delete Account</title>
<meta charset="utf-8">
	...
	<div class="container">
		...
		<ul class="nav nav-tabs">
			...
			<li><a href="${pageContext.request.contextPath}/reopen_account">Reopen
					Account</a></li>
			<li><a href="${pageContext.request.contextPath}/pii_access">Access PII</a></li>
			<li><a href="${pageContext.request.contextPath}/modify_internal_roles">Modify User Roles</a></li>

		</ul>
		<!-- Page Heading -->
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Delete Internal User Account</h1>
			</div>
		</div>
		<div class="tab-content">
			<div id="home" class="tab-pane fade in active">
				<div class="table-responsive">
					<form:form method="POST" action="delete_account">
